(module
  ...
  (type $t16 (func (param i64 i64 i32) (result i32)))
  (type $t17 (func))
  ...
  (func $f10 (type $t17))
  (func $f14 (type $t11) (param $p0 i32))
  (func $apply (export "apply") (type $t15) (param $p0 i64) (param $p1 i64) (param $p2 i64)
    (local $l3 i32)
    global.get $g0
    i32.const 16
    i32.sub
    ...
    i32.add
    global.set $g0)
  (func $f13 (type $t16) (param $p0 i64) (param $p1 i64) (param $p2 i32) (result i32)
    local.get $p0
    i32.wrap/i64
    local.get $p1
    call $requireauth_check
    i32.const 1
    )

  (func $requireauth_check (type $t1) (param $p0 i32) (param $p1 i64)
